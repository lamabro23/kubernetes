...
func diskSetUp(manager diskManager, b iscsiDiskMounter, volPath string, mounter mount.Interface, fsUser, fsGroup *int64, fsGroupChangePolicy *v1.PodFSGroupChangePolicy) error {
